...
<div class="panel panel-primary">
	...
	<h4><i class="fas fa-search"></i> Consultar Hitos</h4>
	</div>
    	<div class="panel-body">
    		<div class="row">
    		<div class="col-sm-4">
    		<div class="form-group">  
   			<label>Ingrese palabra clave para buscar</label>
    		<div class="input-group">
		    <div class="input-group-addon">
    		<i class="fas fa-binoculars" aria-hidden="true"></i>
    		</div>    
    		<input type="text" id="busqueda" onKeyDown="mayuscula(this)" onKeyUp="mayuscula(this)" class="form-control" />
    		</div>
    		</div>
    		</div>
    		</div>
    ...
    <div class="panel panel-primary">
	<div class="panel-heading">
	<h4><i class="fas fa-binoculars"></i> Resultados de B&uacute;squeda</h4>
	</div>
    	<div class="panel-body">
